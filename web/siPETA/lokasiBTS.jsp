...
<html lang="en">
    ...
    <%
        ...
        try {
            ...
            String Data = "select * from tb_peta where lokasi_sto like 'B%' ";
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Lokasi BTS Telkomsel</h1>                        
                        </div>
                        
                        <!--SEARCH
                        <form method="post" name="frm" action="Search">
                            <table border="0" width="300" align="right" bgcolor="#e9f">
                                <tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="thumbnail"><img src="../assets/images/locbts.jpg" alt="Thumbnail Image 1" style="padding-top: 10px;" >
                                <div class="caption">
                                    <center>           
                                        <a href="https://www.google.com/maps?z=30&q=<%=rs.getString("lat")%>,<%=rs.getString("long")%>" target="_blank" class="btn btn-success"  role="button">
