...
<%
    ...
    String query = "UPDATE stok_bbm_master set jumlah_pemakaian_solar = " + baru + " "
            + "WHERE witel='" + witel + "' AND tanggal='" + yyyymmdd + "';";
    boolean canProceed = con.executeQuery(query);
     

    con.activitLog(nik, "stok_bbm_detail", "Mengganti data jumlah pemakaian solar dari " + lama + " menjadi " + baru + " untuk laporan stok BBM bulan " + tanggal);
    con.closeConnection();

    out.print(new BasicJson().getBasicJson(true, "Data jumlah pemakaian solar telah diperbarui").toString());
