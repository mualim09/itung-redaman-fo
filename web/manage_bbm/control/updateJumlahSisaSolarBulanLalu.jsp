...
<%
    ...
    String query = "UPDATE stok_bbm_master set jumlah_sisa_bulan_lalu_solar = " + baru + " "
            + "WHERE witel='" + witel + "' AND tanggal='" + yyyymmdd + "';";
    boolean canProceed = con.executeQuery(query);
     

    con.activitLog(nik, "stok_bbm_detail", "Mengganti data jumlah sisa solar bulan lalu dari " + lama + " menjadi " + baru + " untuk laporan stok BBM bulan " + tanggal);
    con.closeConnection();

    out.print(new BasicJson().getBasicJson(true, "Data jumlah sisa solar bulan lalu telah diperbarui").toString());
