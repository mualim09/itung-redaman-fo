...
<%
    ...
    String query = "UPDATE stok_bbm_master set pembelian_solar = " + baru + " "
    ...
    con.activitLog(nik, "stok_bbm_detail", "Mengganti data pembelian solar dari " + lama + " menjadi " + baru + " untuk laporan stok BBM bulan " + tanggal);
    con.closeConnection();

    out.print(new BasicJson().getBasicJson(true, "Data pembelian solar telah diperbarui").toString());
