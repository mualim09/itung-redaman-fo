...
<%
    ...
    String query = "UPDATE stok_bbm_master set jumlah_persediaan_oli = " + baru + " "
            + "WHERE witel='" + witel + "' AND tanggal='" + yyyymmdd + "';";
    boolean canProceed = con.executeQuery(query);
     

    con.activitLog(nik, "stok_bbm_detail", "Mengganti data jumlah persediaan oli dari " + lama + " menjadi " + baru + " untuk laporan stok BBM bulan " + tanggal);
    con.closeConnection();

    out.print(new BasicJson().getBasicJson(true, "Data jumlah persediaan oli telah diperbarui").toString());
