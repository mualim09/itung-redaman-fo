<%-- 
    Document   : updateJumlahPemakaianSolar
    Created on : Dec 11, 2018, 9:23:50 AM
    Author     : Lenovo
--%>
...
<%
    ...
    String query = "UPDATE stok_bbm_master set jumlah_penambahan_solar = " + baru + " "
    ...
    con.activitLog(nik, "stok_bbm_detail", "Mengganti data jumlah penambahan solar dari " + lama + " menjadi " + baru + " untuk laporan stok BBM bulan " + tanggal);
    con.closeConnection();

    out.print(new BasicJson().getBasicJson(true, "Data jumlah penambahan solar telah diperbarui").toString());
