...
<%
    ...
    String query = "SELECT `Id`, `type`, kap, jumlah FROM cme_air_conditioner WHERE witel='" + witel + "' AND node='" + node + "'; ";
    ...
    if(arr.size()<1){
        out.print("<tr class='text-center'><td colspan='4'>Belum ada AC</td></tr>");
        return;
    }
